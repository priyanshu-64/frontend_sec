function Bgs() 
{
    return(
        <div className=" ">
                    <div class="relative" id="parallex2">
            <div class=" h-full w-full grid grid-cols-1 md:grid-cols-2  absolute content-center  ">
          ...
          <div className="space-y-8 py-4">
            ...
            <button class="bg-transparent hover:bg-blue-500 text-white font-semibold hover:text-white py-2 w-40 px-4 border-4 border-white hover:border-transparent">
  Button
</button>
        ...
        <div class="bg-fixed bg-no-repeat bg-cover  h-[500px]" style={{'background-image': 'url(A4.jpg)'}}></div>
        </div>
