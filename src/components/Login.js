...
export default function Login({ visible, onClose }) {
  ...
  return (
    <div>
      ...
      >
        <div className="w-96  fixed  md:w-[92rem] mt-1 bg-[url('https://images.pexels.com/photos/633409/pexels-photo-633409.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-contain  ">
